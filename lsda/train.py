...
# gradient cul
parser.add_argument('--cul_interval',              type=int,   help='梯度累计', default=1)
...
def main_worker(gpu, ngpus_per_node, args):
    ...
    while epoch < args.num_epochs:
        ...
        for step, sample_batched in enumerate(dataloader.data):
            ...
            # 为了解决超显存
            os.environ["PYTORCH_CUDA_ALLOC_CONF"] = "max_split_size_mb:64"  # 总是报显存不足的问题，是因为碎片没完全释放
            ...
            # loss = silog_criterion.forward(depth_est, depth_gt, mask.to(torch.bool))  # 源代码
            loss_r = silog_criterion.forward(depth_est, depth_gt, mask.to(torch.bool))  # 梯度累计
            loss = loss_r
            loss_r = loss_r / args.cul_interval
            loss_r.backward()
            ...
            # optimizer.step()  # 源代码
            if (step+1)%args.cul_interval==0 : # 梯度累计
                optimizer.step()
                optimizer.zero_grad()
